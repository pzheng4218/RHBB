...
# plt.ylim(10**(-12), 10**(-2))
line1, = plt.semilogy(epochs, SS1, linestyle='--', linewidth=1.8, marker='o', color='darkorange', label=r'mS2GD-RHBB(2)+ - pure')
line2, = plt.semilogy(epochs, SS2, linestyle='-', linewidth=1.8, color='fuchsia', marker='o', label=r'mS2GD-RHBB(2)+ $\sigma_1=0.6$ $\sigma_2=0.2$')
line3, = plt.semilogy(epochs, SS3, linestyle='--', linewidth=1.8, color='royalblue', marker='o', label=r'mS2GD-RHBB(3)+ - pure')
line4, = plt.semilogy(epochs, SS4, linestyle='-', linewidth=1.8, color='silver', marker='o', label=r'mS2GD-RHBB(3)+ $\sigma_1=0.6$ $\sigma_2=0.2$')
line5, = plt.semilogy(epochs, SS5, linestyle='--', linewidth=1.8, color='cyan', marker='o', label=r'mS2GD-RHBB(4)+ - pure')
line6, = plt.semilogy(epochs, SS6, linestyle='-', linewidth=1.8, color='blueviolet', marker='o', label=r'mS2GD-RHBB(4)+ $\sigma_1=0.6$ $\sigma_2=0.2$')
line7, = plt.semilogy(epochs, SS7, linestyle='--', linewidth=1.8, color='gold', marker='o', label=r'mS2GD-RHBB(5)+ - pure')
line8, = plt.semilogy(epochs, SS8, linestyle='-', linewidth=1.8, color='pink', marker='o', label=r'mS2GD-RHBB(5)+ $\sigma_1=0.6$ $\sigma_2=0.2$')
font1 = {'size': 7}
plt.legend(handles=[line1, line2, line3, line4, line5, line6, line7, line8], prop=font1)
# plt.savefig('adaptive_german_mS2GD-RHBB+_I.eps', dpi=600, format='eps')
plt.show()
