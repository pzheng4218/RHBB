...
plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass4, SS1, linestyle='--', linewidth=2.5, color='gold', label=r'mS2GD-RHBB(3)  {$\tilde{\eta}_0^s$}=mix1')
line2, = plt.semilogy(pass4, SS2, linestyle='-', linewidth=2.5, color='hotpink', label=r'mS2GD-RHBB(3)  {$\tilde{\eta}_0^s$}=mix2')
line3, = plt.semilogy(pass4, SS3, linestyle='--', linewidth=2.5, color='lightgreen', label=r'mS2GD-RHBB(3)  {$\tilde{\eta}_0^s$}=mix3')
line4, = plt.semilogy(pass4, SS4, linestyle='-', linewidth=2.5, color='lightskyblue', label=r'mS2GD-RHBB(3)  {$\tilde{\eta}_0^s$}=mix4')
# line5, = plt.semilogy(pass4, SS, linestyle='-', linewidth=2.5, color='silver', label=r'MB-holder-RHBB(13)  $b=4$ $b_H=40$ $\gamma=1$')
font1 = {'size': 7}
plt.legend(handles=[line1, line2, line3, line4], prop=font1)
# plt.savefig('a8a2_init_mix.eps', dpi=600, format='eps')
plt.show()
