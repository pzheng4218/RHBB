...
plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass1, SS1, linestyle='-', linewidth=2, color='black', label=r'mS2GD-RCBB(3)')
line2, = plt.semilogy(pass2, SS2, linestyle='-', linewidth=2, color='lightpink', label=r'MB-SARAH-RCBB(3)')
