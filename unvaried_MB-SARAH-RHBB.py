...
lam = 10**(-2)
holder = DataHolder('mushrooms', 0, lam)
inner_loop = 35
outer_epoch = 20
omega = 0
eta_0 = 0.1
...
plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass4, SS1, linestyle='--', linewidth=2.5, color='brown', label=r'MB-SARAH-RBB $b=4$ $b_H=40$ $\gamma=1$')
line2, = plt.semilogy(pass4, SSC, linestyle='-', linewidth=2.5, color='lightpink', label=r'MB-SARAH-RHBB(10)  $b=4$ $b_H=40$ $\gamma=1$')
line3, = plt.semilogy(pass4, SSC2, linestyle='-', linewidth=2.5, color='cyan', label=r'MB-SARAH-RHBB(11)  $b=4$ $b_H=40$ $\gamma=1$')
line4, = plt.semilogy(pass4, SSC3, linestyle='-', linewidth=2.5, color='mediumpurple', label=r'MB-SARAH-RHBB(12)  $b=4$ $b_H=40$ $\gamma=1$')
line5, = plt.semilogy(pass4, SSC4, linestyle='-', linewidth=2.5, color='silver', label=r'MB-SARAH-RHBB(13)  $b=4$ $b_H=40$ $\gamma=1$')
font1 = {'size': 7}
plt.legend(handles=[line1, line2, line3, line4, line5], prop=font1)
# plt.savefig('mushrooms_s_all.eps', dpi=600, format='eps')
plt.show()
