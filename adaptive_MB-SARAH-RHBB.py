...
for k in range(1, outer_epoch+1):
    ...
    for j in range(1, inner_loop+1):
        ...
        ita1 = (1 / max(size_bh, size_bh2)) * gamma * (np.linalg.norm(s, ord=2) ** 2) / s.dot(y1)
...
# plt.ylim(10**(-12), 10**(-2))
line1, = plt.semilogy(epochs, SS1, linestyle='--', linewidth=1.8, color='hotpink', label=r'MB-SARAH-RHBB(2)-pure')
line2, = plt.semilogy(epochs, SS2, linestyle='-', linewidth=1.8, color='green', marker='o', label=r'MB-SARAH-RHBB(2) $\sigma_1=0.4$ $\sigma_2=0.4$')
line3, = plt.semilogy(epochs, SS3, linestyle='--', linewidth=1.8, color='deepskyblue', label=r'MB-SARAH-RHBB(3)-pure')
line4, = plt.semilogy(epochs, SS4, linestyle='-', linewidth=1.8, color='chocolate', marker='o', label=r'MB-SARAH-RHBB(3) $\sigma_1=0.4$ $\sigma_2=0.4$')
line5, = plt.semilogy(epochs, SS5, linestyle='--', linewidth=1.8, color='mediumpurple', label=r'MB-SARAH-RHBB(4)-pure')
line6, = plt.semilogy(epochs, SS6, linestyle='-', linewidth=1.8, color='silver', marker='o', label=r'MB-SARAH-RHBB(4) $\sigma_1=0.4$ $\sigma_2=0.4$')
line7, = plt.semilogy(epochs, SS7, linestyle='-', linewidth=1.8, color='olive', label=r'MB-SARAH-RBB')
line8, = plt.semilogy(epochs, SS8, linestyle='--', linewidth=1.8, color='yellow', label=r'MB-SARAH-RHBB(5)-pure')
line9, = plt.semilogy(epochs, SS9, linestyle='-', linewidth=1.8, color='teal', marker='o', label=r'MB-SARAH-RHBB(5) $\sigma_1=0.4$ $\sigma_2=0.4$')
font1 = {'size': 7}
plt.legend(handles=[line7, line1, line2, line3, line4, line5, line6, line8, line9], prop=font1)
# plt.savefig('adaptive_w8a_3_MB-SARAH.eps', dpi=600, format='eps')
plt.show()
