...
lam = 10**(-2)
holder = DataHolder('covtype', 0, lam)
inner_loop = 30
outer_epoch = 1
omega = 0
eta_0 = 0.1
...
plt.ylabel(r'$||\nabla P(w)||^2$')
pass1 = np.array([int(i) for i in range(1, inner_loop+3)])
# plt.xlim(0, 50)
plt.xticks(range(0, inner_loop+1, 5))
# plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass1, S1, linestyle='--', linewidth=2.5, color='darkviolet', marker='*', markersize=5, label=r'mS2GD-RBB $b=4$ $b_H=40$ $\gamma_2=1$')
line2, = plt.semilogy(pass1, SC, linestyle='-', linewidth=2.5, color='cornflowerblue', marker='o', markersize=5, label=r'mS2GD-RHBB(2)  $b=4$ $b_H=40$ $\gamma_2=1$')
line3, = plt.semilogy(pass1, SC2, linestyle='-', linewidth=2.5, color='green', marker='o', markersize=5, label=r'mS2GD-RHBB(3)  $b=4$ $b_H=40$ $\gamma_2=1$')
line4, = plt.semilogy(pass1, SC3, linestyle='-', linewidth=2.5, color='tan', marker='o', markersize=5, label=r'mS2GD-RHBB(4)  $b=4$ $b_H=40$ $\gamma_2=1$')
line5, = plt.semilogy(pass1, SC4, linestyle='-', linewidth=2.5, color='lightcoral', marker='o', markersize=5, label=r'mS2GD-RHBB(5)  $b=4$ $b_H=40$ $\gamma_2=1$')
font1 = {'size': 7}
plt.legend(handles=[line1, line2, line3, line4, line5], prop=font1)
plt.savefig('covtype_single2.eps', dpi=600, format='eps')
plt.show()
