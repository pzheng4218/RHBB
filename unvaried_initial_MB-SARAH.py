...
plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass4, SS1, linestyle='--', linewidth=2.5, color='gold', label=r'MB-SARAH-RHBB(3)  {$\eta_0^s$}={0.05}')
line2, = plt.semilogy(pass4, SS2, linestyle='-', linewidth=2.5, color='hotpink', label=r'MB-SARAH-RHBB(3)  {$\eta_0^s$}={0.1}')
line3, = plt.semilogy(pass4, SS3, linestyle='--', linewidth=2.5, color='lightgreen', label=r'MB-SARAH-RHBB(3)  {$\eta_0^s$}={0.5}')
line4, = plt.semilogy(pass4, SS4, linestyle='-', linewidth=2.5, color='lightskyblue', label=r'MB-SARAH-RHBB(3)  {$\eta_0^s$}={1}')
...
# plt.savefig('a8a_init.eps', dpi=600, format='eps')
plt.show()
