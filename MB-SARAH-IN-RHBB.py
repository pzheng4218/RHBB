...
# plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass1, S1, linestyle='-.', linewidth=2.5, color='rosybrown', marker='*', markersize=5, label=r'MB-SARAH-RBB $b=4$ $b_H=40$ $\gamma=1$')
line2, = plt.semilogy(pass1, SC, linestyle='-', linewidth=2.5, color='lightgreen', marker='o', markersize=5, label=r'MB-SARAH-RHBB(2)  $b=4$ $b_H=40$ $\gamma=1$')
line3, = plt.semilogy(pass1, SC2, linestyle='-', linewidth=2.5, color='orange', marker='o', markersize=5, label=r'MB-SARAH-RHBB(3)  $b=4$ $b_H=40$ $\gamma=1$')
line4, = plt.semilogy(pass1, SC3, linestyle='-', linewidth=2.5, color='blue', marker='o', markersize=5, label=r'MB-SARAH-RHBB(4)  $b=4$ $b_H=40$ $\gamma=1$')
line5, = plt.semilogy(pass1, SC4, linestyle='-', linewidth=2.5, color='violet', marker='o', markersize=5, label=r'MB-SARAH-RHBB(5)  $b=4$ $b_H=40$ $\gamma=1$')
font1 = {'size': 7}
plt.legend(handles=[line1, line2, line3, line4, line5], prop=font1)
# plt.savefig('a8a_single.eps', dpi=600, format='eps')
plt.show()
