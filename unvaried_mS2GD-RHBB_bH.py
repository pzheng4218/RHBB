...
plt.ylim(10**(-14), 10**(-2))
line1, = plt.semilogy(pass1, SS1, linestyle='--', linewidth=2.2, color='brown', marker='o', label=r'mS2GD-RHBB(3) $b=4$ $b_H=20$ $\gamma_2=1$')
line2, = plt.semilogy(pass1, SS2, linestyle='-', linewidth=2.2, color='pink', marker='o', label=r'mS2GD-RHBB(3)  $b=4$ $b_H=30$ $\gamma_2=1$')
line3, = plt.semilogy(pass1, SS3, linestyle='-', linewidth=2.2, color='aqua', marker='o', label=r'mS2GD-RHBB(3)  $b=4$ $b_H=40$ $\gamma_2=1$')
line4, = plt.semilogy(pass1, SS4, linestyle='-', linewidth=2.2, color='mediumslateblue', marker='o', label=r'mS2GD-RHBB(3)  $b=50$ $b_H=45$ $\gamma_2=1$')
line5, = plt.semilogy(pass1, SS5, linestyle='-', linewidth=2.2, color='gray', marker='o', label=r'mS2GD-RHBB(3)  $b=4$ $b_H=60$ $\gamma_2=1$')
font1 = {'size': 7}
plt.legend(handles=[line1, line2, line3, line4, line5], prop=font1)
# plt.savefig('unvaried_mS2GD-RHBB(3)_bH.eps', dpi=600, format='eps')
plt.show()